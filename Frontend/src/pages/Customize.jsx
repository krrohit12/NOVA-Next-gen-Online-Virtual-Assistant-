...
const Customize = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen bg-gradient-to-t from-black to-[#0c1141] flex justify-center items-center flex-col p-4 lg:p-[20px] relative overflow-x-hidden hide-scrollbar">
      <button
        onClick={() => navigate('/')}
      ...
      <h1 className="text-white text-xl sm:text-2xl lg:text-[30px] text-center mb-6 lg:mb-[30px] px-2">
        Select your{" "}
